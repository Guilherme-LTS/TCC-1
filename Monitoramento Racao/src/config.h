...
// --- Pinos para o Sensor de Peso do RESERVATÓRIO Principal de Ração ---
#define PIN_HX711_RESERVATORIO_PRINCIPAL_DT 16  
#define PIN_HX711_RESERVATORIO_PRINCIPAL_SCK 17 


// --- Parâmetros de Sensores e Lógica para Ração ---
#define HX711_RECIPIENTE_CALIBRATION_FACTOR   0.42f
#define HX711_RESERVATORIO_PRINCIPAL_CALIBRATION_FACTOR 0.42f
