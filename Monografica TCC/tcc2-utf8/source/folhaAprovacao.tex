...
banca avaliadora do Curso de Sistemas de Informa\c{c}\~{a}o,
da Escola Superior de Tecnologia, da Universidade do Estado do Amazonas,
como pr\'e-requisito para obten\c{c}\~{a}o do bacharel em Sistemas de Informa\c{c}\~{a}o.\\

\large \bf Aprovado em:  /06/2025
\end{minipage}
